...
export default function IndividualReport({ student, choirName, attendanceSessions, isLoading }: IndividualReportProps) {
  ...
  return (
    <div className="report-preview mx-auto bg-white p-8 rounded-lg shadow-lg relative" id="report">
      {/* Serial Number top right */}
      <div className="absolute top-4 right-8 text-[10px] text-gray-400 font-mono text-right leading-tight">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Card className="text-center">
                <CardHeader className="p-4 pb-2"><CardTitle className="text-xl">{totalSessions}</CardTitle></CardHeader>
                <CardContent className="p-4 pt-0"><p className="text-xs text-muted-foreground">Total Sessions</p></CardContent>
            </Card>
            <Card className="text-center">
                <CardHeader className="p-4 pb-2"><CardTitle className="text-xl text-primary">{presentCount}</CardTitle></CardHeader>
                <CardContent className="p-4 pt-0"><p className="text-xs text-muted-foreground">Sessions Present</p></CardContent>
            </Card>
            <Card className="text-center">
                <CardHeader className="p-4 pb-2"><CardTitle className="text-xl text-destructive">{absentCount}</CardTitle></CardHeader>
                <CardContent className="p-4 pt-0"><p className="text-xs text-muted-foreground">Sessions Absent</p></CardContent>
            </Card>
            <Card className="text-center">
                <CardHeader className="p-4 pb-2"><CardTitle className="text-xl">{attendancePercentage}%</CardTitle></CardHeader>
                <CardContent className="p-4 pt-0"><p className="text-xs text-muted-foreground">Attendance Rate</p></CardContent>
            </Card>
        </div>
      </section>
